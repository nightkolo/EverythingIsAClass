...
//        System.out.println(userWon);
        ...
        System.out.println(
                String.format(msg2, calPercentageToGoal( goal, saving ))
                // Really not sure how to use this IDE
                // Wanna go back to visual studio code....
                // I think that was a breakpoint
    ...
    // Bad method name
    static double calPercentageToGoal(double max, double min) {
